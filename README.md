...
Successfully developed an interactive Excel dashboard using Zepto-style grocery delivery data. 
The dashboard transforms raw transactional data into meaningful business insights covering sales performance, 
customer analytics, product trends, customer satisfaction, and delivery operations.
